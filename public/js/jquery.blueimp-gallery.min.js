! function(t) {
    ...
    return t.extend(e.prototype, {
 	...
 	//target="blank",
		...
		var imgurl = this.container.find('.slide:eq('+this.index+')').find('img').attr('src');
		var imgalt = this.container.find('.slide:eq('+this.index+')').find('.modal-link').attr('title');
                this.container.find('.slide:eq('+this.index+')').find('.modal-link').attr('href', imgurl);
	        this.container.find('.slide:eq('+this.index+')').find('img').attr('title', imgalt);
        },
        next: function() {
...
function(t) {
    ...
    t.extend(e.prototype.options, {
        ...
        youTubePlayerVars: {
        wmode: "transparent",
	autoplay:1 // Added by Harihar fot autoplay
        },
